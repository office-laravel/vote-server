...
@section('content')
                    ...
                    @for ($i = 1; $i < 3; $i++)
                        <div class="col-sm-6 col-md-3 ans-col">
                            <div class="form-group row">
                                ...
                                <input type="file" accept="image/*" class="custom-file-input input-file-op" name="img_op[{{ $i }}]" id="image-op-{{ $i }}" style="display: none;">
                                <span class="col-sm-1 col-2 img-num-span">{{ $i }}-</span>
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-controll inputimg" name="img_op_content[{{ $i }}]" id="img_op_content-{{ $i }}"
                                        placeholder="الخيار {{ $i }}" value="">
                                </div>
                                <button type="button" class="btn-del-op col-sm-1 col-1" style="display: block;"><i
                                        class="fas fa-times" style="font-size:16px;color:red;"></i>
    ...
    <div class="col-sm-6 col-12 ans-col " id="main-op" style="display: none">
        <div class="form-group row">
            ...
            <button type="button" onclick="delsort(this);" class="btn-del-op col-sm-1 col-1" style="display: block;"><i
                    class="fas fa-times" style="font-size:16px;color:red;"></i>
            </button>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3 ans-col"  id="img-main-op" style="display: none">
        <div class="form-group row">
            ...
            <input type="file" accept="image/*" class="custom-file-input input-file-op" name="" id="" style="display: none;">
            <span class="col-sm-1 col-2 img-num-span">{{ $i }}-</span>
            <div class="col-sm-9 col-8">
                <input type="text" class="form-controll inputimg" name="" id=""
                    placeholder="" value="">
            </div>
            <button type="button" onclick="delsort(this);" class="btn-del-op col-sm-1 col-1" style="display: block;"><i
                    class="fas fa-times" style="font-size:16px;color:red;"></i>
